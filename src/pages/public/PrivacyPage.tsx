...
import { Users, Shield, Smartphone, Heart, Globe, MapPin } from 'lucide-react';

const PrivacyPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="py-20 px-4 text-center bg-gradient-to-b from-travel-primary-50 to-white">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
          <div className="text-center p-6">
            <Shield className="w-12 h-12 text-travel-primary-500 mx-auto mb-4" />
          ...
          <div className="text-center p-6">
            <Users className="w-12 h-12 text-travel-primary-500 mx-auto mb-4" />
          ...
          <div className="text-center p-6">
            <MapPin className="w-12 h-12 text-travel-primary-500 mx-auto mb-4" />
        ...
        <div className="max-w-6xl mx-auto space-y-20">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              <div className="bg-gradient-to-br from-travel-primary-50 to-travel-secondary-50 rounded-3xl p-8">
            ...
            <div className="h-[300px] flex flex-col justify-center">
              <div className="grid grid-cols-2 gap-4 ">
                <div className="bg-white rounded-xl p-6 shadow-md text-center">
                  <Shield className="w-8 h-8 text-travel-primary-500 mx-auto mb-3" />
                ...
                <div className="bg-white rounded-xl p-6 shadow-md text-center">
                  <Globe className="w-8 h-8 text-travel-primary-500 mx-auto mb-3" />
