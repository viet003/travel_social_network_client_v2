      ...
      <div className="mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Icon icon="fluent:bookmark-24-filled" className="w-10 h-10 text-gray-900" />
            <div>
          ...
          <button
            ...
            className="flex cursor-pointer hover:bg-gray-100 items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg transition-colors whitespace-nowrap flex-shrink-0"
          >
